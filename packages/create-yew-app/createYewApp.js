...
run("git", ["clone", "--no-tags", "--depth", "1", "https://github.com/Thamognya/create-yew-app.git", gitFolder]);
...
cpr(path.join(gitFolder, "crates/yew-app"), folderName, {}, function (err, files) {
  ...
  if (err) {
    ...
    console.log(" Rust + WebAssembly + Yew = love ");
    console.log();
    ...
    console.log();
    console.log(' Visit https://github.com/Thamognya/create-yew-app for more information. ');
    console.log('Inspired by https://github.com/jetli/create-yew-app');
  }
});